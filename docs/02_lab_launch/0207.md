...
1.  After the provisioning process finishes, you can create the other applications — `customers-service`, `vets-service`, and `visits-service`.
    ...
    <summary><b>(Optional)</b> If you encounter errors when running this script, you can try to manually create them, one by one. <a>Click here to view the CLI commands you can use to do this.</a></summary>
