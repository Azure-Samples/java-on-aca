...
{: .note }
We already collected your subscription information as part of the [preparing your subscription]({% link install.md %}#configure-your-subscription-and-deploy-pre-requisite-azure-resources) instructions. Make sure you've completed this process and and any other [installation steps]({% link install.md %}) are complete before proceeding.
