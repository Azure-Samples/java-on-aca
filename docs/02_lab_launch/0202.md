...
1.  Create a new Azure Container Apps environment in your resource group, and configure it to use the new subnet. 
    ...
    {: .note}
    > If you've already successfully run the `create-azure-resources.sh` script discussed in the [installation instructions]({% link install.md %}#configure-your-subscription-and-deploy-pre-requisite-azure-resources), you can skip this step.
